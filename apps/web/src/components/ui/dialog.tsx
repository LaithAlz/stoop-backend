...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /** Styling hook for the built-in close button. A dialog that refuses
     *  to close while a write is in flight (see app.account.tsx's edit
     *  form) uses this to hide it — a visibly-enabled control that does
