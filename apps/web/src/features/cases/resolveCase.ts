 ...
 * wording is test-covered rather than inlined in the screen. Ported
 * verbatim from apps/mobile/src/features/cases/resolveCase.ts (campaign
 * issue #234 PR 3; that string set was already copy-reviewed there).
 *
