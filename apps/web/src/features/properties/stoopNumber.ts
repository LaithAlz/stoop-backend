 ...
 * twilio_number`) — the number tenants text. Pure, ported verbatim from
 * apps/mobile/src/features/properties/stoopNumber.ts (campaign issue #234
 * PR 4).
 *
 ...
 * date — flagged in the mobile M2 report as a follow-up the API needs to
 * offer.
 */
