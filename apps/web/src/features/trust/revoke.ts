 ...
 * the screen wraps these in a confirm dialog and a useMutation. Ported
 * verbatim from apps/mobile/src/features/trust/revoke.ts (campaign issue
 * #234 PR 4; that copy was already reviewed there).
 *
