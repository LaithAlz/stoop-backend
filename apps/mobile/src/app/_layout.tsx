/**
 * Root layout — the auth gate. Wraps the whole app in AuthProvider, then
 * uses Expo Router's Protected Routes (`Stack.Protected`) to show either
 * the sign-in screen or the tab shell, driven by `resolveAuthRoute` (the
 * single source of truth for that decision — also unit-tested directly in
 * src/app/__tests__/auth-gate.test.tsx).
 */
