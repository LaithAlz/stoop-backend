...
**v1.19 amendment (2026-07-23 — #203 items 1 & 2, the #53 provisioning
safety re-review's follow-ups):** no request/response shape change; two
behavior notes updating the v1.12 amendment above, which is now stale on
both points:
